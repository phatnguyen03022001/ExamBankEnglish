...
const QuestionUpdate = ({sendDataToParent, questionForID}) => {
  const [question, setQuestion] = useState({
    questionID: 1,
    type: questionForID.type,
    titleQuestion: questionForID.titleQuestion,
    options: questionForID.options,
    answer: questionForID.answer,
    optionsDoc: questionForID.optionsDoc,
    answerDoc: questionForID.answerDoc,
    level: questionForID.level,
  });
  ...
  return (
    <div className="text-sm bg-white dark:bg-stone-900 rounded-lg border border-stone-200 dark:border-stone-700 p-6 mb-6 hover:border-stone-400 dark:hover:border-stone-400 transition-border duration-300 ease-in-out">
      ...
      <div className="mb-6">
        ...
        {questionForID.type === "trắc nghiệm" && (
          <Mulchoise
            question={question}
        ...
        {questionForID.type === "điền khuyết" && (
          <FillTheValue
            question={question}
            handleChangeQuestion={handleChangeQuestion}
            handleCorrectAnswerChange={handleCorrectAnswerChange}
        ...
        {questionForID.type === "shortAnswer" && (
          <ShortAnswer
            question={question}
            handleChangeQuestion={handleChangeQuestion}
            questionForID={questionForID}
